...
function spawnSilverCoins() {
  if (frameCount % 1000 === 0) {
    ...
    if (distance % 5000 === 0 && silverCoin.velocityY < 25) {
      silverCoin.velocityY += 1;
    }
  }
}
...
function spawnGoldCoins() {
  if (frameCount % 2000 === 0) {
    ...
    if (distance % 5000 === 0 && goldCoin.velocityY < 40) {
      goldCoin.velocityY += 1;
    }
  }
}
...
function spawnWeapons() {
  ...
  if (distance % 5000 === 0 && weapon.velocityY < -1);
  {
    weapon.velocityY -= 1;
  }
}
...
function spawnFuel() {
  if (distance % 10000 === 0) {
    ...
    if (distance % 10000 === 0 && fuel.velocityY < 15) {
      fuel.velocityY += 1;
    }
  }
}
